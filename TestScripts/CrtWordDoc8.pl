...
my($list)=$word->ListGalleries(wdOutlineNumberGallery)->ListTemplates(5)->ListLevels(1)->{NumberFormat}="%1";
$list=$word->ListGalleries(wdOutlineNumberGallery)->ListTemplates(5)->ListLevels(1)->{StartAt}="4";
$list=$word->ListGalleries(wdOutlineNumberGallery)->ListTemplates(5)->ListLevels(1)->{LinkedStyle}="Heading 1";

$list=$word->ListGalleries(wdOutlineNumberGallery)->ListTemplates(5)->ListLevels(2)->{NumberFormat}="%1.%1";
$list=$word->ListGalleries(wdOutlineNumberGallery)->ListTemplates(5)->ListLevels(2)->{StartAt}="1";
$list=$word->ListGalleries(wdOutlineNumberGallery)->ListTemplates(5)->ListLevels(2)->{LinkedStyle}="Heading 2";
