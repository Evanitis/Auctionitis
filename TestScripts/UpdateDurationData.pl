#------------------------------------------------------------------------------------------------------------
# This program is used to update the Durations table with the latest dration data.
#
# Created   : 14/05/06
# Input     : Update version number, Attribute update file name
# 
# Command line format: UpdateDurationData <x.x> <inputfilename>
#
...
# 
# if the update is run the attributes version numnber is updated in the Auctionitis properties file
#
#------------------------------------------------------------------------------------------------------------
use strict;
use DBI;
...
#------------------------------------------------------------------------------------------------------------
# Check the current attribute version - if update version less than or equal to current release then exit
#------------------------------------------------------------------------------------------------------------
