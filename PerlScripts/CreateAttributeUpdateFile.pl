...
# 
# Command line format: CreateAttributeUpdateFile AttributeDataV2.41.html
#
...
my $dbh = DBI->connect( "dbi:SQLite:dbname=auctionitis.db3","","" ) or die "Unable to connect: $DBI::errstr\n";
